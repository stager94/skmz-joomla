<?php
/**
* version 1.0 JSnowfall
* @copyright Copyright (C) 2008 Jfriendly.net. All rights reserved.
* @license http://www.gnu.org/copyleft/gpl.html GNU/GPL
* 
* Javascript Code by Scott Schiller - http://schillmania.com
* Adapted for Joomla by JFriendly.net
*/
...
<br />
<span class="jbgstyle">snow by</span> <a href="http://www.jfriendly.net"><img src="<?php echo $url.JText::_("/modules/mod_snowfall/image/jsnowfall.png")?>" width="36" height="14" alt="jsnowfall" align="absmiddle"/></a>
...
function SnowStorm() {
  ...
  var imagePath = '<?php echo JURI::root(); ?>modules/mod_snowfall/image/snow/'; // relative path to snow images
  var flakesMax = 128;
