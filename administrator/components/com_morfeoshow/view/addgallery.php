...
?>	
	...
	<table class="admintable">
		...
		<tr>
			...
			<td>
				<?php echo $editor->display( 'description', '' ,'100%', 
		...
		<tr>
			...
			<td>
				<?php echo $editor->display( 'description1', '' ,'100%', 
...
<?php if ($params_morfeo["googlekey"]) { ?>
...
?>			
		<table class="admintable">
			...
			<span class="editlinktip hasTip" title="<?php echo JText::_('Google id info');	?>">			  
			  ...
			  <td valign="top">
			<input type="text" size="120" name="gmapkey" value="<?php echo $params_morfeo["googlekey"]?>" />
				</td>
			</tr>
			<tr>
			  <td width="30%" class="key">
			  ...
			  <td valign="top">
			<input type="text" style="width:70%" name="luogo" value="" />
				</td>
			</tr>			
				<tr>
			  <td width="30%" class="key">
			...
			<input type="text" style="width:70%" name="gaddress" value="" /><input type="button" onclick="showAddress();" value="<?php echo JText::_( 'Search' ); ?>" />
			  ...
			  <td valign="top">
						<input type="text" size="20" name="glat" value="<?php echo $vamba->glat ?>" /><input type="text" size="20" name="glng" value="<?php echo $vamba->glng ?>" /><input type="button" onclick="getCoordinate();" value="<?php echo JText::_( 'Search Coordinates' ); ?>" />
					</td>
			</tr>
			  <td width="30%" class="key">
			  <label for="title">
			  ...
			  <td valign="top">
				<input type="radio" name="gzoom" value="5" <?php if($vamba->gzoom==5) echo 'checked="checked"' ?> onfocus="javascript:changeZoom(5)" />5
				<input type="radio" name="gzoom" value="6" <?php if($vamba->gzoom==6) echo 'checked="checked"' ?> onfocus="javascript:changeZoom(6)" />6
				<input type="radio" name="gzoom" value="7" <?php if($vamba->gzoom==7) echo 'checked="checked"' ?> onfocus="javascript:changeZoom(7)" />7
				<input type="radio" name="gzoom" value="8" <?php if($vamba->gzoom==8) echo 'checked="checked"' ?> onfocus="javascript:changeZoom(8)" />8
				<input type="radio" name="gzoom" value="9" <?php if($vamba->gzoom==9) echo 'checked="checked"' ?> onfocus="javascript:changeZoom(9)" />9
				<input type="radio" name="gzoom" value="10" <?php if($vamba->gzoom==10) echo 'checked="checked"' ?> onfocus="javascript:changeZoom(10)" />10
				<input type="radio" name="gzoom" value="11" <?php if($vamba->gzoom==11) echo 'checked="checked"' ?> onfocus="javascript:changeZoom(11)" />11
				<input type="radio" name="gzoom" value="12" <?php if($vamba->gzoom==12) echo 'checked="checked"' ?> onfocus="javascript:changeZoom(12)" />12
				<input type="radio" name="gzoom" value="13" <?php if($vamba->gzoom==13) echo 'checked="checked"' ?> onfocus="javascript:changeZoom(13)" />13
				<input type="radio" name="gzoom" value="14" <?php if($vamba->gzoom==14) echo 'checked="checked"' ?> onfocus="javascript:changeZoom(14)" />14
					</td>
			</tr>
			  <td width="30%" class="key">
			  <label for="title">
...
?>	
		...
		<tr>
			...
			<input class="text_area" type="text" name="user_id" id="user_id" size="25" maxlength="100"
				value="<?php echo $params_morfeo["user_id"] ?>" />
			</td>
		</tr>
...
?>
		...
		<tr>
			...
			<td>
				...
				maxlength="10" value="FFFFFF" />
			</td>
		</tr>
		<tr>
			<td width="100" align="right" class="key">
				<span class="editlinktip hasTip" title="<?php echo JText::_('Height');	?>">			
				<?php echo JText::_( 'Set Height' ); ?>
				<span>				
			</td>
			<td>
				<input class="text_area" type="text" name="paltezza" id="paltezza" size="6" 
				maxlength="6" value="420" />
			</td>
		</tr>
		<tr>
			<td width="100" align="right" class="key">
				<span class="editlinktip hasTip" title="<?php echo JText::_('Width');	?>">			
				<?php echo JText::_( 'Set Width' ); ?>
				<span>				
			</td>
			<td>
				<input class="text_area" type="text" name="plarghezza" id="plarghezza" size="6" 
				maxlength="6" value="500" />
			</td>
		</tr>		
		</table>		
			<?php
		...
		<table class="adminform">
			...
			<tr>
				<td align="left" valign="top">
					<textarea class="inputbox"  rows="5" style="width:99%" name="metadesc"></textarea>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="left">
					<textarea class="inputbox"  rows="5" style="width:99%" name="metakey"></textarea>
				</td>
			</tr>
		</tr>
	</table>
